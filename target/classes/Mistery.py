...
path = "//187.188.105.168/shared/Files_Mystery/Sin_Procesar_Daily"
pathP = "//187.188.105.168/shared/Files_Mystery/Procesados_Daily"
dest = "//187.188.105.168/shared/Files_2Databases/MysteryEGM_Daily"
...
try:
    for file in csvfiles:
          ...
          dataset['EGM'] = dataset['EGM'].apply(lambda x: re.sub(r"[_]|[ ]|server|SERVER", '', x)).apply(lambda x: str.upper(x))
